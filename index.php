                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse pull-right">
                        <ul class="nav" id="top-navigation">
                            ...
                            <?php if(empty($_SESSION['id']) && empty($_SESSION['user_fb_info'])): ?>
            ...
            <div id="da-slider" class="da-slider">
                ...
                <div class="container">
                    ...
                    <div class="da-slide">
                        ...
                        <h4>企画する</h4>
                        <p>企画を立ててみよう！＆企画を評価してみよう！</p>
                        <a href="#" class="da-link button">Read more</a>
                        <div class="da-img">
                            <img src="images/planslide.png" alt="image01" width="320">
                        </div>
                    </div>
                    <!-- End first slide -->
                    <!-- Start second slide -->
                    <div class="da-slide">
                        <h2>DO</h2>
                        <h4>やってみる</h4>
                        <p>面白ろそうな企画検証記事を見てみよう！＆面白そうな企画を検証してみよう！</p>
                        <a href="#" class="da-link button">Read more</a>
                        <div class="da-img">
                            <img src="images/doslide.png" width="320" alt="image02">
                        </div>
                    </div>
                    <!-- End second slide -->
                    <!-- Start third slide -->
                    <div class="da-slide">
                        ...
                        <a href="#" class="da-link button">Read more</a>
                        <div class="da-img">
                            <img src="images/checkslide.png" width="320" alt="image03">
                        </div>
                    </div>
                    <!-- End third slide -->
                    <!-- Start forth slide -->
                    <div class="da-slide">
                        <h2>ACTION</h2>
                        <h4>改善する</h4>
                        <p>企画の結果から導きだされた改善案を見よう！検証記事から改善案を書き込もう！</p>
                        <a href="#" class="da-link button">Read more</a>
                        <div class="da-img">
                            <img src="images/actionslide.png" width="320" alt="image03">
                        </div>
                    </div>
                    <!-- End forth slide -->
            ...
            <div class="container">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span3">
                        <div class="centered service">
                            <div class="circle-border zoom-in">
                                <a href="do_check.php"><img class="img-circle" src="images/check.png" alt="service 3"></a>
                            </div>
                            <h3>CHECK</h3>
                            <p>検証記事を見て評価しよう！</p>
                        </div>
