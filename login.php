                                ...
                                <form id="contact-form" action="" method="post">
                                    <div class="control-group">
                                        <div class="controls">
                                            ...
                                            <!--エラー警告表示-->
                                            <p><font color="black"><?php if (!empty($error) and $error=="false") {echo "メールアドレスが違います";}?></font></p>
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            ...
                                            <!--エラー警告表示-->
                                            <p><font color="black"><?php if (!empty($error) and $error=="false") {echo "パスワードが違います";}?></font></p>
