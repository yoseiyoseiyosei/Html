                        ...
                        <div class="span4">
                            <div class="testimonial">
                                ...
                                <div class="whopic">
                                    ...
                                    <br><button id="subscribe" class="button button-sp"><a href="updateall.php?planid=<?php echo htmlSC($planInfo['plan_id']); ?>">編集</a></button>　<button id="subscribe" class="button button-sp"><a href="plan.php?planid=<?php echo htmlSC($planInfo['plan_id']); ?>">消去</a></button>
                                    <?php endif ?>
                                </div>
                            </div>
                        </div>
