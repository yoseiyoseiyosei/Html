                                ...
                                <form id="contact-form" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                                ...
                                                <input type="password" name="password" class="span10" placeholder="パスワード8文字以上" value="<?php echo htmlspecialchars($form['password']) ?>" maxlenth="255" />
                                                <!--エラー警告表示-->
                                                <p><font color="black">
